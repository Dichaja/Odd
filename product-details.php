            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-wrap items-center gap-6 text-sm">
                        <div class="flex items-center cursor-pointer" @click="activeTab='reviews'; $nextTick(() => { document.getElementById('reviews-section')?.scrollIntoView({ behavior: 'smooth', block: 'start' }); })">
                            <div class="flex mr-2">
                                <?php 
        ...
        <div x-show="activeTab==='reviews'" class="tab-content" id="reviews-section">
            ...
            <div class="lg:hidden reviews-mobile-layout">
                ...
                <div class="review-list-mobile">
                    <div class="bg-white dark:bg-secondary rounded-xl shadow-sm p-6 lg:p-8 border border-gray-200 dark:border-white/10">
