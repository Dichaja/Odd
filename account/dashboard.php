    ...
    <div class="content-section">
        <div class="p-6 flex flex-col sm:flex-row justify-between items-center gap-4">
            ...
            <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                ...
                <a href="order-desk"
                    class="h-10 px-4 bg-user-primary text-white rounded-lg hover:bg-user-primary/90 transition-colors flex items-center gap-2 justify-center w-full sm:w-auto">
        ...
        <div class="p-6">
            ...
            <div class="mb-4 text-center">
                <p class="text-sm text-gray-text">
                    ...
                    Include UGX 2,000 Transaction Charges When Not Using Your <a href="zzimba-credit"
                        class="text-user-primary font-medium">Zzimba Credit</a> Account
                </p>
            </div>
            <form id="subscriptionForm">
                <div class="space-y-4">
                    <div>
                        <input type="text" id="getVendor" placeholder="Search Vendor..."
                    ...
                    <div>
                        ...
                        <div class="flex justify-center gap-4">
                            <div class="payment-option" data-method="credit">
                                <div
                                    class="w-16 h-16 rounded-lg bg-gray-50 flex items-center justify-center mb-2 cursor-pointer hover:bg-user-secondary transition-colors">
