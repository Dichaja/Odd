        ...
        <div class="max-w-6xl mx-auto">
            <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    <button id="add-money-btn" onclick="showPaymentMethodModal()" disabled
                        class="px-6 py-3 bg-gray-400 text-white rounded-xl cursor-not-allowed opacity-60 flex items-center gap-2 font-medium shadow-lg">
                        <i class="fas fa-plus"></i><span>Topup</span>
                    </button>
                    <button id="send-credit-btn" onclick="showSendCreditModal()" disabled
                        class="px-6 py-3 bg-gray-400 text-white rounded-xl cursor-not-allowed opacity-60 flex items-center gap-2 font-medium shadow-lg">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const apiUrl = <?= json_encode(BASE_URL . 'vendor-store/fetch/manageZzimbaCredit.php') ?>;
