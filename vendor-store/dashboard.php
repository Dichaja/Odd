            ...
            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
                ...
                <a href="<?= BASE_URL ?>vendor-store/products"
                    ...
                    <div
                        ...
                        <i data-lucide="box" class="w-6 h-6 text-red-600 group-hover:text-user-primary"></i>
                    </div>
                ...
                <a href="<?= BASE_URL ?>vendor-store/zzimba-credit"
                    ...
                    <div
                        ...
                        <i data-lucide="credit-card" class="w-6 h-6 text-purple-600 group-hover:text-user-primary"></i>
                    </div>
                ...
                <a href="<?= BASE_URL ?>vendor-store/sms-center"
                    ...
                    <div
                        ...
                        <i data-lucide="message-square"
                            class="w-6 h-6 text-green-600 group-hover:text-user-primary"></i>
                    </div>
                ...
                <a href="<?= BASE_URL ?>vendor-store/store-profile"
                    ...
                    <div
                        ...
                        <i data-lucide="store" class="w-6 h-6 text-indigo-600 group-hover:text-user-primary"></i>
                    </div>
            ...
            <div class="p-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    ...
                    <button onclick="refreshActivity(event)"
                        class="text-sm text-user-primary hover:text-user-primary/80 flex items-center gap-2">
                ...
                <div id="recentActivity" class="space-y-4">
                    <div class="flex items-center justify-center py-8">
                        <div class="text-center">
                            <i data-lucide="loader-2" class="w-8 h-8 text-user-primary mb-2 animate-spin"></i>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        <div class="w-8 h-8 bg-user-primary/10 rounded-lg flex items-center justify-center">
                            <i data-lucide="flame" class="w-5 h-5 text-user-primary"></i>
                        </div>
...
<script>
    ...
    function updateRecentActivity(activities) {
        ...
        container.innerHTML = activities.map(activity => {
            const icon = activity.type === 'request' ? 'calendar-check-2' : activity.type === 'transaction' ? 'credit-card' : 'info';
            ...
            return `
                <div class="flex items-center gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-900 truncate">${escapeHtml(activity.description)}</p>
    ...
    function refreshActivity(evt) {
        loadRecentActivity();
        const svg = evt.currentTarget.querySelector('svg');
        if (svg) {
            svg.classList.add('animate-spin');
            setTimeout(() => svg.classList.remove('animate-spin'), 1000);
        }
    }
    ...
    function showLoading() { const el = document.getElementById('loadingOverlay'); if (el) el.classList.remove('hidden'); }
